        ...
        */
        while (true){
            ...
            Coroutine::CreateRun([&] () {
              ...
              auto empty_cmd = std::make_shared<TpcCopilotSampleCommand>();
              ...
              ((CoordinatorCopilot *)coo)->Submit(sp_m, std::function<void()>(), std::function<void()>());
